...
export function compareAccesses(left: OperationPathAccess, right: OperationPathAccess): number {
  return (
    ...
    byCodeUnit(left.role, right.role) ||
...
function operationAccesses(plan: CampaignPlan, operation: PlanOperation, index: number): OperationPathAccess[] {
  switch (operation.kind) {
    ...
    case "rewrite-fs-reference":
      return [
        access(
          ...
          index,
          operation.kind,
          operation.rewrites.map((rewrite) => rewrite.donor),
        ),
      ];
    ...
    case "lockfile-importer":
      return [
        access(plan, operation.lockfile, "exact", "read-write", "lockfile-importer", index, operation.kind, [
...
function writeRole(generator: string | undefined): PathAccessRole {
  switch (generator) {
    ...
    case "wiring:consumer-project-references":
      return "consumer-project-references";
    case "scaffold:workspace-membership":
      return "workspace-registry";
    case "scaffold:project-registration":
      return "task-registry";
    case "scaffold:entrypoint":
      return "entrypoint";
...
function writeKeys(plan: CampaignPlan, generator: string | undefined): string[] {
  switch (generator) {
    case "scaffold:workspace-membership":
    case "wiring:consumer-project-references":
      return [plan.manifest.target.packageRoot];
    case "scaffold:project-registration":
