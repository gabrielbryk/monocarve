...
function validateProvenanceAgreement(manifest: ExtractionManifest, actual: NonNullable<ExtractionManifest["provenance"]>, options: ValidatePlanOptions, issues: Issues): void {
