...
export function sourceConservation(
  ...
  return {
    ...
    plannedFiles: categories.files.length, plannedTests: categories.tests.length, plannedAssets: categories.assets.length,
    landedFiles: landed.files, landedTests: landed.tests, landedAssets: landed.assets,
  };
}
