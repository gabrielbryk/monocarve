...
function setup(source: string) {
  ...
  const config = fixtureConfig(root, {
    preparation: { gates: { workspace: ["true"] }, commit: { subject: "refactor: split normalize value" } },
  ...
  const rendering = { commit: { subject: "refactor: split normalize value" }, gates: { package: [], project: [], workspace: ["true"] } };
