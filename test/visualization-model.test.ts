...
const records: readonly ModuleNode[] = [node("apps/web/src/a.ts", "ui", 10), node("apps/web/src/b.ts", "ui", 20), node("apps/web/src/c.ts", "data", 30)];
...
function graph(nodes: readonly ModuleNode[], inputEdges: readonly ModuleEdge[]): DependencyGraph {
  ...
  return {
    ...
    testKinds: new Map(),
    workspace: {} as DependencyGraph["workspace"],
  };
}
